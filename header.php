            ...
            <div class="top-header">
                <div class="top-header-inside container">
                   ...
                   <div class="top-header-social-medias">
                        <a href="#"><img class="top-header-facebook-img" src="assets/images/icons/fb-logo.svg" width="22px" height="22px"/></a>
                        <a href="#"><img class="top-header-instagram-img" src="assets/images/icons/insta-logo.svg" width="22px" height="22px"/></a>
                   </div>
                   <span class="vertical-line"></span>
                   <img class="top-header-phone-img" src="assets/images/icons/phone.png" width="20px" height="20px"/>
            ...
            <div class="main-header">
                <div class="main-header-inside container">
                    ...
                    <div class="main-header-inside-middle">
                        ...
                        <div class="bottom-menus"></div>
                    </div>

                    <div class="logo-fae">
                    <img src="assets/images/logos/FAE-logo.svg" alt="Faculdade Anglicana de Erechim">
                    </div>
                </div>
            </div>
        </header>
